...
def generate_video(message_id, user_id):
    ...
    if not settings["audio_settings"]["only_audio"]:
        video = add_combined_audio(video, message_id, duration)
    else:
        video = add_audio(video, message_id)
